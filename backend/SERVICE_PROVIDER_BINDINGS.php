...
/**
 * SERVICE PROVIDER BINDING GUIDE
 *
 * Add the following bindings to app/Providers/AppServiceProvider.php
 * in the register() method to enable dependency injection for all services.
 */
