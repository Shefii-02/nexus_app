...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::put('staff/{id}/permission-update', [StaffController::class, 'permissionUpdate']);
    ...
    //                 'start_time'  => $now->copy()->subMinutes(20)->toIso8601String(true),
    //                 'end_time'    => $now->copy()->addMinutes(40)->toIso8601String(true),
    //                 'status'      => 'live',
    ...
    //                 'start_time'  => $now->copy()->addHours(1)->addMinutes(30)->toIso8601String(true),
    //                 'end_time'    => $now->copy()->addHours(3)->toIso8601String(true),
    //                 'status'      => 'upcoming',
    ...
    //                 'description' => null,
    //                 'start_time'  => $now->copy()->addHours(4)->toIso8601String(true),
    //                 'end_time'    => $now->copy()->addHours(5)->toIso8601String(true),
    //                 'status'      => 'upcoming',
    ...
    //                 'start_time'  => $now->copy()->subHours(3)->toIso8601String(true),
    //                 'end_time'    => $now->copy()->subHours(2)->toIso8601String(true),
    //                 'status'      => 'completed',
    ...
    //                 'start_time'  => $now->copy()->subHours(5)->toIso8601String(true),
    //                 'end_time'    => $now->copy()->subHours(4)->toIso8601String(true),
    //                 'status'      => 'completed',
    ...
    //                 'description' => null,
    //                 'start_time'  => $now->copy()->subHours(6)->toIso8601String(true),
    //                 'end_time'    => $now->copy()->subHours(5)->toIso8601String(true),
    //                 'status'      => 'completed',
    //                 'class_link'  => null,
    //                 'record_link' => null,
    //                 'teacher'     => null,
